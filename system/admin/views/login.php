...
<div id="adm_login">
    ...
    <input value="<?php lang('Username'); ?>" name="login" type="text" />
    <input value="<?php lang('Password'); ?>" name="password" type="password" />
    <button onclick="processAuth();" id="adm_btn_login"><?php lang('Login'); ?></button>
    </form>
</div>
<script>
    $(function(){
