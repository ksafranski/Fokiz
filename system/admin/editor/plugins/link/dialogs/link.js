                                    ...
                                    },
                                    {
                                        ...
                                        validate : function()
                                        {
                                            ...
                                            for (var i=0; i<window.frames.length; i++) {
                                               if(window.frames[i].name == 'iframePageLinks') {
                                                  var selected = window.frames[i].document.getElementById("page_links");
                                                  if(selected.value) {
                                                     pageLinksValue = selected.value;
                                                     var protocolCmb = dialog.getContentElement( 'info', 'protocol' );
                                                     protocolCmb.setValue( '' );
                                                     this.setValue(pageLinksValue);
                                                  }
                                               }
                                            }
                     ...
                     [
                        {
                           ...
                           label : 'Page Links',
                           style : 'width : 100%;',
                           html : '<iframe src="/system/admin/editor/plugins/link/dialogs/iframe.php" frameborder="0" name="iframePageLinks" id="iframePageLinks" allowtransparency="1" style="width:100%;margin:0;padding:0;"></iframe>'
                        }
                     ]
                  }
               ]
